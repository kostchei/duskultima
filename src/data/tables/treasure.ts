...
export interface CoreTreasureItemSpec {
  ...
  /** Per-result craftsmanship overrides layered over the canonical base item. */
  slotCost?: number;
...
interface CoreTreasureRow extends TreasureCraftsmanship {
  min: number;
  max: number;
  text: string;
  valueGp: number;
...
function row(
  ...
  baseItemId?: string,
  qty?: number,
  craftsmanship: TreasureCraftsmanship = {},
): CoreTreasureRow {
  return { min, max, text, valueGp, baseItemId, qty, ...craftsmanship };
}
...
const CORE_ROWS = {
  "0-3": [
    ...
    row(26, 27, "Longbow and bundle of 40 arrows (10 gp)", 10, "longbow"),
    row(28, 29, "Dusty, leather armor dyed black (10 gp)", 10, "leather-armor"),
    row(30, 31, "Scuffed, heavy shield (10 gp)", 10, "shield"),
    row(32, 33, "Simple, well-made bastard sword (10 gp)", 10, "bastard-sword"),
    row(34, 35, "12 gp in the pocket of a ripped cloak", 12),
    row(36, 37, "Wavy-bladed greatsword (12 gp)", 12, "greatsword"),
    row(38, 39, "Pair of elf-forged shortswords (14 gp)", 14, "shortsword", 2, {
      slotCost: 0,
      magicBonus: 1,
      benefits: ["Elf-forged balance grants +1 to attack and damage; each sword occupies no gear slots."],
    }),
    ...
    row(54, 55, "Two finely forged dwarven shields (20 gp)", 20, "shield", 2, {
      slotCost: 0,
      magicBonus: 1,
      benefits: ["Dwarven construction grants +3 AC while readied and occupies no gear slots."],
    }),
    row(56, 57, "Pair of silvered daggers (10 gp each)", 20, "dagger", 2),
    ...
    row(66, 67, "Half-finished suit of chainmail (30 gp)", 30, "chainmail"),
    row(68, 69, "Matched trio of warhammers (10 gp each)", 30, "warhammer", 3),
    ...
    row(78, 79, "Mithral shield etched with soaring dragons (40 gp)", 40, "shield", undefined, {
      slotCost: 0,
      magicBonus: 1,
      benefits: ["Mithral construction grants +3 AC while readied and occupies no gear slots."],
    }),
    row(80, 81, "Gold monkey idol with a ruby gripped in its teeth (60 gp)", 60),
    row(82, 83, "Fine suit of chainmail (60 gp)", 60, "chainmail"),
  ...
  "4-6": [
    ...
    row(6, 7, "Steel-banded wooden shield (10 gp)", 10, "shield"),
    row(8, 9, "Golden anchor necklace (10 gp)", 10),
    row(10, 11, "Bag of 20 glass marbles (5 sp each)", 10),
    row(12, 13, "Serrated greatsword (12 gp)", 12, "greatsword"),
    row(14, 15, "Three silver-tipped javelins (4 gp each)", 12, "javelin", 3),
    ...
    row(32, 33, "Ceremonial, gold-capped warhammer (40 gp)", 40, "warhammer"),
    ...
    row(40, 41, "Half-complete suit of chainmail (50 gp)", 50, "chainmail"),
    row(42, 43, "Mace inlaid with gold holy symbols (50 gp)", 50, "mace"),
    ...
    row(50, 53, "Longsword with a fiery pearl set in the pommel (50 gp)", 50, "longsword"),
    ...
    row(60, 61, "Suit of dwarf-made chainmail (60 gp)", 60, "chainmail", undefined, {
      slotCost: 1,
      benefits: ["Dwarf-made links occupy one gear slot instead of two."],
    }),
    row(62, 63, "Dragonbone crossbow carved as roaring dragon (60 gp)", 60, "crossbow"),
    row(64, 65, "Half-complete suit of plate mail (65 gp)", 65, "plate-mail"),
    ...
    row(76, 77, "Mithral shield inlaid with small, blue pearls (80 gp)", 80, "shield", undefined, {
      slotCost: 0,
      magicBonus: 1,
      benefits: ["Mithral construction grants +3 AC while readied and occupies no gear slots."],
    }),
    row(78, 79, "Two intact griffon eggs (40 gp each)", 80),
    row(80, 81, "Suit of blackened-steel plate mail (130 gp)", 130, "plate-mail"),
  ...
  "7-9": [
    ...
    row(6, 7, "Greatsword made of blue steel (15 gp)", 15, "greatsword"),
    row(8, 9, "Tall, thin mirror in a bronze frame (20 gp)", 20),
    row(10, 11, "Pair of bastard swords with griffon pommels (20 gp)", 20, "bastard-sword", 2),
    ...
    row(20, 21, "Ironwood longbow engraved with silver leaves (35 gp)", 35, "longbow"),
    row(22, 23, "Mahogany chess board with silver pieces (40 gp)", 40),
    row(24, 25, "Mithral shield polished to a mirror-shine (45 gp)", 45, "shield", undefined, {
      slotCost: 0,
      magicBonus: 1,
      benefits: ["Mithral construction grants +3 AC while readied and occupies no gear slots."],
    }),
    ...
    row(38, 39, "Chainmail with several rows of gold links (75 gp)", 75, "chainmail"),
  ...
  "10-plus": [
    ...
    row(6, 7, "Damaged chainmail in need of repair (50 gp)", 50, "chainmail"),
    row(8, 9, "Five matching, ceremonial greatswords (12 gp each)", 60, "greatsword", 5),
    row(10, 11, "Chipped emerald worth half its value (60 gp)", 60),
    row(12, 13, "Gold ring with a large, black pearl (65 gp)", 65),
    row(14, 15, "Suit of crimson chainmail with matching shield (70 gp)", 70, "chainmail"),
    ...
    row(22, 23, "Dagger with emerald in the pommel (120 gp)", 120, "dagger"),
    row(24, 25, "A trio of pearls with blue and violet hues (40 gp each)", 120),
    row(26, 27, "Suit of plate mail shaped to look like a minotaur (130 gp)", 130, "plate-mail"),
    row(28, 29, "Suit of blue plate mail with crashing wave motif (130 gp)", 130, "plate-mail"),
    ...
    row(34, 35, "Dragonbone greataxe with a ruby in pommel (220 gp)", 220, "greataxe"),
    row(36, 37, "Gold scarab dotted with miniature emeralds (220 gp)", 220),
    row(38, 39, "Chest brimming with 230 gp", 230),
    row(40, 41, "Silvered staff tipped with a ruby held in a claw (220 gp)", 220, "staff"),
    ...
    row(54, 55, "Mithral suit of elvish chainmail (240 gp)", 240, "mithral-chainmail"),
...
export const CORE_TREASURE_ITEM_SPECS: readonly CoreTreasureItemSpec[] = (
  ...
  qty: entry.qty ?? spendableCoinQty(entry),
  treasureQuality: treasureQuality(entry),
  magicBonus: entry.magicBonus ?? tableMagicBonus(entry.text),
