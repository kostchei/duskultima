...
export const DIABLERIE_ROSTER: readonly MonsterDef[] = [
  ...
  d("wolf", "Wolf", { level: 1, role: "skirmisher", archetype: "quadruped", size: "medium", art: WOLF }),
  ...
  d("barrow-thane", "Barrow Thane", { level: 9, role: "soldier", archetype: "skeletal", size: "large", art: BARROW_ARMED, undead: true }),
  d("barrow-skeleton", "Barrow Skeleton", { level: 1, role: "soldier", archetype: "skeletal", size: "medium", art: BARROW_BONE, undead: true }),
  d("barrow-housecarl", "Barrow Housecarl", { level: 3, role: "soldier", archetype: "skeletal", size: "medium", art: BARROW_ARMED, undead: true }),
  d("spectre", "Spectre", { level: 6, role: "caster", archetype: "elemental", size: "medium", art: SPECTRE, undead: true, specialAbility: "shadow-extinct" }),
  d("rotting-flesh-golem", "Rotting Flesh Golem", { level: 8, role: "brute", archetype: "brute", size: "huge", art: FLESH_GOLEM, undead: true }),
  d("frostbound-boneling", "Frostbound Boneling", { level: 7, role: "caster", archetype: "skeletal", size: "medium", art: FROST_BONE, undead: true }),
  d("bramble-lich", "Bramble Lich", { level: 10, role: "champion", archetype: "skeletal", size: "large", art: LICH, undead: true, specialAbility: "shadow-extinct" }),
];
